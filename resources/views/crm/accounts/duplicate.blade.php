          ...
          <div class="x_title">
            ...
            <form class="form-horizontal" role="add-account" method="POST" action="{{url('crm/accounts')}}">
              ...
              <div class="col-md-6 col-sm-6">
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6">
                    <input type="text" disabled="" placeholder="Cutomer No." value="AUTO GEN ON SAVE" value="{{$account['customer_number']}}" required="required" class="form-control">
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6">
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                  <input type="date" id="date_lead_recieved" placeholder="Date of Lead Recieved" value="{{$account['date_lead_recieved']}}" name="date_lead_recieved" required="required"  class="form-control">
                </div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6">
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                  <input type="date"  value="{{$account['date_of_injury']}}" name="date_of_injury"  placeholder="dd-mm-yyyy" class="form-control">
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                  <input type="date"  value="{{$account['date_of_injury_aware']}}" name="date_of_injury_aware"  placeholder="dd-mm-yyyy" class="form-control">
                </div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6">
             <div class="item form-group">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                  <input type="date"  value="{{$account['facebook_injury_date']}}" name="facebook_injury_date"  placeholder="dd-mm-yyyy" class="form-control">
                </div>
              </div>
            </div>
              @php $myfromnae=[]; $i=0; @endphp
              ...
              <div class="col-md-12 col-sm-12">
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                      <input id="name" class="form-control"  value="{{$account['call_back_time']}}" name="call_back_time" placeholder="Call back Date"  type="time">
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                      <input id="name" class="form-control" value="{{$account['call_back_date']}}" name="call_back_date" placeholder="Call Back Time"  type="date">
                    </div>
                  </div>
                </div>
              @php $myfromnae=[]; $i=0; @endphp
            ...
            <div class="col-md-6 col-sm-6">
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                  <input type="date" id="date_of_birth" value="{{$account['date_of_birth']}}" name="date_of_birth"   placeholder="Date Of Birth" class="form-control">
                </div>
              </div>
              <div class="item form-group">
