    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form class="form-horizontal" role="add-lead-source" method="POST" action="{{url('crm/lead-source')}}">
              ...
              <div class="col-md-12 col-sm-12">
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6">
                    <input  class="form-control" name="lead_source" placeholder="Lead Source"  type="text">
                  </div>
                </div>
