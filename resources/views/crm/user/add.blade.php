    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form class="form-horizontal" role="add-user-role" method="POST" action="{{url('crm/user')}}">
              ...
              <div class="col-md-6 col-sm-6">
               ...
               <div class="col-md-6 col-sm-6">
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6">
                    <input type="text"  placeholder="Modile" name="mobile" class="form-control">
                  </div>
                </div>
              <div class="item form-group">
              ...
              <div class="form-group">
                <div class="col-md-6 offset-md-3">
                  ...
                  <button  data-request="ajax-submit" data-target='[role="add-user-role"]' type="button" class="btn btn-success">Submit</button>
                </div>
              </div>
            </form>
          </div>
